...
pub struct Cursor<'a> {
    ...
    chars: Chars<'a>,
    pub frontmatter_allowed: FrontmatterAllowed,
...
impl<'a> Cursor<'a> {
    ...
    pub fn bump_if(&mut self, byte: char) -> bool {
    ...
    pub fn bump_either(&mut self, byte1: char, byte2: char) -> bool {
        let mut chars = self.chars.clone();
    ...
    pub fn eat_until(&mut self, byte: u8) -> bool {
    ...
    pub fn eat_past_either(&mut self, byte1: u8, byte2: u8) -> Option<u8> {
